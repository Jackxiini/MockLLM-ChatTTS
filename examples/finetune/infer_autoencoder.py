"""
CUDA_VISIBLE_DEVICES=0 python -m examples.finetune.infer_autoencoder --data_path E:/Code/AudioLLM/Xz/888.list --tar_path data/Xz.tar --dvae_path saved_models/dvae.pth
"""
